 ...
 * @author Mourad Fahmi
 */
public class Login_PManager extends javax.swing.JFrame {

    /**
     * Creates new form PharmacyManager_login
     */
    public Login_PManager() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pharmacy Manager Login page");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Login_PManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Login_PManager().setVisible(true);
            }
        });
    }
