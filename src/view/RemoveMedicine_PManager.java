 ...
 * @author Mourad Fahmi
 */
public class RemoveMedicine_PManager extends javax.swing.JFrame {

    /**
     * Creates new form RemoveMedicine_PManager
     */
    public RemoveMedicine_PManager() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Medicine removal");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveMedicine_PManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveMedicine_PManager().setVisible(true);
            }
        });
    }
